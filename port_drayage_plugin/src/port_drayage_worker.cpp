...
namespace port_drayage_plugin
{
    ...
    void PortDrayageWorker::mobility_operation_message_parser(std::string mobility_operation_strategy_params) {
        ...
        // If this is CMV is commanded to pickup new cargo, check that it isn't already carrying cargo
        if (_latest_mobility_operation_msg.operation == PORT_DRAYAGE_PICKUP_OPERATION_ID && _has_cargo) {
